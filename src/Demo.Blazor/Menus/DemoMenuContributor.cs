...
public class DemoMenuContributor : IMenuContributor
{
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        context.Menu.AddItem(new ApplicationMenuItem(DemoMenus.Home, displayName: "测试用页面", "/ForTestPages", icon: "fa fa-warning")
     .AddItem(new ApplicationMenuItem(DemoMenus.Home, displayName: "测试用页面1", "/TestPage1"))
     .AddItem(new ApplicationMenuItem(DemoMenus.Home, displayName: "测试用页面2", "/TestPage2")));


        context.Menu.AddItem(new ApplicationMenuItem(DemoMenus.Home, displayName: "工作流管理", "/vskyWorkFlowManage", icon: "fa fa-warning"));
